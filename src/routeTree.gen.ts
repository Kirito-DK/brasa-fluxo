...
import { Route as FornecedoresImport } from './routes/_authenticated/fornecedores'
...
const FornecedoresRoute=FornecedoresImport.update({id:'/_authenticated/fornecedores',path:'/fornecedores',getParentRoute:()=>AuthenticatedRoute} as any)
...
const children={PainelRoute,ClientesRoute,EstoqueRoute,FornecedoresRoute,OrcamentosRoute,PedidosRoute,ProducaoRoute,ProdutosRoute,FinanceiroRoute,CalendarioRoute,ConfigRoute}
